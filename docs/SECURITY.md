...
The deployed canonical contract remains 0.3.0 at `0x74D8aEc8BF79369BeDdCae000214552Dcc7D00A9` until a new candidate is deployed and verified. Its measurement transaction `0x75daf13670200403477bed9beb07ea5200a83973f4bf106f296de66f12bfe0ba` ended `UNDETERMINED`; incident `cv-i-2` remains `MEASUREMENT_PENDING` and must not be retried. Candidate 0.4.0 adds provider-neutral interval clipping, sorting and merging, with non-overlapping sources marked non-contributing. New live testing must use a fresh agreement after the candidate is green, deployed to Studionet 61999 and source/schema verified. Releases 0.2.0 and earlier are historical.
