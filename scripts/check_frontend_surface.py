...
required_actions = ['open_incident', 'verify_measurement', 'claim_exception', 'adjudicate_exception', 'challenge_exception', 'resolve_challenge', 'finalize_default_breach', 'finalize_incident', 'withdraw_credit']
failures=[]
