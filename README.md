...
Release 0.4.0 source commit `ba037c4148f8f79b45b781fe3200def9a817fb54` passed [CI run 35606141013](https://github.com/ometere123/carveout/actions/runs/35606141013); the latest green main CI is [run 35608857030](https://github.com/ometere123/carveout/actions/runs/35608857030) for release wiring commit `96f1d1bb67707a7f3c61ef7bf20077f65906498d`. The superseded 0.3.0 live measurement for `cv-i-2` (transaction `0x75daf13670200403477bed9beb07ea5200a83973f4bf106f296de66f12bfe0ba`) reached `UNDETERMINED` and remains `MEASUREMENT_PENDING`; preserve it and do not retry. The full economic lifecycle on 0.4.0 is not demonstrated; application writes remain user-approved.
