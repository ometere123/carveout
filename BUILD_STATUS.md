...
This status reflects CARVEOUT main UI commit `351d283278b39870f123495dde6643f52151cdea` and the 2026-09-20 verification pass.
...
| GenVM lint / validate / schema / typecheck | PASS in GitHub Actions run [35519567715](https://github.com/ometere123/carveout/actions/runs/35519567715) for main commit `351d283`. |
...
| Production frontend | READY: `https://carve-out.vercel.app`; deployment `dpl_DvNdou86SF8oGDqF3Ya1kidSVEco` from UI commit `351d283`; all six routes return HTTP 200, and the corrected favicon is served from `/icon.svg`. |
...
| Exact main commit CI | PASS: [run 35519567715](https://github.com/ometere123/carveout/actions/runs/35519567715). |
